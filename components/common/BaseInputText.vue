...
<template>
  <div class="flex flex-col gap-2">
    ...
    <div class="flex flex-col">
      <InputText class="flex-1" :id="props.name" :class="[classInput, errorMessage ? 'p-invalid' : '']"
        :style="styleInput" type="text" :placeholder="placeholder" v-model="value" @blur="handleBlur($event, true)"
        :disabled="disabled" />
